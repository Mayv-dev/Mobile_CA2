...
struct Question: Hashable {
    ...
    static let allQuestions: [Question] = [
        Question(questionText: NSLocalizedString("What year does the UN aim to end poverty ?", comment: "Question 1") ,
                 possibleAnswers: [
        ...
        Question(questionText: NSLocalizedString("What is considered the international poverty line (living on less than)?", comment: "Question 2") ,
                 possibleAnswers: [
        ...
        Question(questionText: NSLocalizedString("What region has the highest poverty rate?", comment: "Question 3") ,
                 possibleAnswers: [
        ...
        Question(questionText: NSLocalizedString("What is the Goal", comment: "Question 4") ,
                 possibleAnswers: [
        ...
        Question(questionText: NSLocalizedString("How many million people live in extreme poverty?", comment: "Question 5") ,
                 possibleAnswers: [
